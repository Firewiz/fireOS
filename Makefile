...
OBJS=kernel.o vga.o stdlib.o asmintr.o idt_c.o inthandle.o irq.o keyboard.o disk.o fat.o printf.o malloc.o boot.o idt_s.o mt.o syscall.o paging.o timer.o shell.o elf.o gdt_c.o gdt_s.o
PROG=fireos.bin
